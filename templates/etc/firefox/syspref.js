...
pref("browser.cache.offline.storage.enable", false); // [FF71+] [DEFAULT: false FF84+]
...
// HINT !!!
//
//    to avoid missing HTTP "Accept-Language" set pref (its user_pref!!)
