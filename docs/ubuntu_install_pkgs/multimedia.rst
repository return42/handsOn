...
* :deb:`openshot` : `OpenShot`_ ist ein Viedeo-Editor

* :deb:`qmmp` : `Qmmp`_ ist ein Qt basierter Multimedia Player
...
.. code-block:: bash
   ...
   $ sudo -H ./scripts/ubuntu_install_pkgs.sh multimedia
