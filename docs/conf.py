...
extlinks = {}
# usage:    :man:`make`
extlinks['man']       = ('http://manpages.ubuntu.com/cgi-bin/search.py?q=%s', '%s')
#extlinks['man']      = ('http://manpages.ubuntu.com/manpages/' + language + '/%s.html', '%s')
extlinks['deb']       = ('http://packages.ubuntu.com/%s', '%s')
#extlinks['rfc']      = ('https://tools.ietf.org/html/rfc%s', 'RFC %s')
extlinks['launchpad'] = ('https://launchpad.net/%s/trunk', '%s@launchpad')
extlinks['origin']    = ('https://github.com/return42/handsOn/blob/master/%s', 'git://%s')
extlinks['commit']    = ('https://github.com/return42/handsOn/commit/%s', '#%s')
extlinks['apache_mod']  = ('https://httpd.apache.org/docs/current/mod/%s.html', 'Apache %s')
