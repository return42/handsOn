...
Jahren immerwieder irgendwelche Probleme, siehe auch `Citrix Receiver
(ubuntu)`_.  Grundsätzlich kann man den Client aber auch unter Linux
installieren, und nutzen. In alten Versionen musste man da noch mit den i386 und
...
-- scheinenen nur ein paar Zertifikate zu fehlen um eine Verbindung aufzubauen.
...
Im Web-Browser baut man dann inital die Verbindung auf und meldet sich an der
...
Öffnet man eine solche ``.ica`` Datei bekommt man (linux) eine ziemlich
irreführende Fehlermeldung:

.. figure:: citrix-receiver-error-dialog.png

Das eigentliche Problem ist i.d.R. aber, dass dem Citrix-Client die gängigen
